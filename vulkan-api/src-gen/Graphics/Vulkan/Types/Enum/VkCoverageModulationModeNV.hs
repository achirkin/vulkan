...
{-# LANGUAGE Strict                     #-}
module Graphics.Vulkan.Types.Enum.VkCoverageModulationModeNV
...
-- | type = @enum@
--
--   <https://www.khronos.org/registry/vulkan/specs/1.1-extensions/html/vkspec.html#VkCoverageModulationModeNVVkCoverageModulationModeNV registry at www.khronos.org>
