...
instance VulkanMarshal VkSwapchainDisplayNativeHdrCreateInfoAMD
    ...
    type StructRep VkSwapchainDisplayNativeHdrCreateInfoAMD =
         'StructMeta "VkSwapchainDisplayNativeHdrCreateInfoAMD" -- ' closing tick for hsc2hs
           VkSwapchainDisplayNativeHdrCreateInfoAMD
           #{size VkSwapchainDisplayNativeHdrCreateInfoAMD}
           #{alignment VkSwapchainDisplayNativeHdrCreateInfoAMD}
           '[('FieldMeta "sType" VkStructureType 'False  -- ' closing tick for hsc2hs
                                                        #{offset VkSwapchainDisplayNativeHdrCreateInfoAMD, sType}
                1
                'True -- ' closing tick for hsc2hs
                'True), -- ' closing tick for hsc2hs
             ('FieldMeta "pNext" (Ptr Void) 'False 
                                                   #{offset VkSwapchainDisplayNativeHdrCreateInfoAMD, pNext}
                1
                'True -- ' closing tick for hsc2hs
                'True), -- ' closing tick for hsc2hs
             ('FieldMeta "localDimmingEnable" VkBool32 'False 
                                                              #{offset VkSwapchainDisplayNativeHdrCreateInfoAMD, localDimmingEnable}
                1
                'True -- ' closing tick for hsc2hs
                'True)] -- ' closing tick for hsc2hs
           'False -- ' closing tick for hsc2hs
