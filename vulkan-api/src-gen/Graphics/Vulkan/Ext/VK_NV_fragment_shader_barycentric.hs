...
module Graphics.Vulkan.Ext.VK_NV_fragment_shader_barycentric
       (-- * Vulkan extension: @VK_NV_fragment_shader_barycentric@
        -- |
        --
        -- supported: @vulkan@
        --
...
pattern VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME <-
        (is_VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME -> True)
  where
    VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME
      = _VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME

{-# INLINE _VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME #-}

_VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME :: CString
_VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME
  = Ptr "VK_NV_fragment_shader_barycentric\NUL"#

{-# INLINE is_VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME #-}

is_VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME ::
                                                    CString -> Bool
is_VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME
  = (EQ ==) .
      cmpCStrings _VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME

type VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME =
