...
module Graphics.Vulkan.Ext.VK_NV_external_memory_capabilities
       (AHardwareBuffer(), ANativeWindow(), CAMetalLayer(), VkBool32(..),
        ...
        VkSampleMask(..), VkExtent3D, VkExternalImageFormatPropertiesNV,
        ...
        VkImageViewCreateFlags(), VkResult(..), VkAccelerationStructureKHR,
...
--   >     )
--
--   <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#vkGetPhysicalDeviceExternalImageFormatPropertiesNV vkGetPhysicalDeviceExternalImageFormatPropertiesNV registry at www.khronos.org>
