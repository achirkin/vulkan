...
module Graphics.Vulkan.Ext.VK_EXT_4444_formats
       (-- * Vulkan extension: @VK_EXT_4444_formats@
        -- |
        --
        -- supported: @vulkan@
        --
        ...
        VkDeviceQueueCreateInfo, VkPhysicalDevice4444FormatsFeaturesEXT,
...
import Graphics.Vulkan.Types.Struct.PhysicalDevice         (VkPhysicalDevice4444FormatsFeaturesEXT,
...
pattern VK_EXT_4444_FORMATS_EXTENSION_NAME <-
        (is_VK_EXT_4444_FORMATS_EXTENSION_NAME -> True)
  where
    VK_EXT_4444_FORMATS_EXTENSION_NAME
      = _VK_EXT_4444_FORMATS_EXTENSION_NAME

{-# INLINE _VK_EXT_4444_FORMATS_EXTENSION_NAME #-}

_VK_EXT_4444_FORMATS_EXTENSION_NAME :: CString
_VK_EXT_4444_FORMATS_EXTENSION_NAME
  = Ptr "VK_EXT_4444_formats\NUL"#

{-# INLINE is_VK_EXT_4444_FORMATS_EXTENSION_NAME #-}

is_VK_EXT_4444_FORMATS_EXTENSION_NAME :: CString -> Bool
is_VK_EXT_4444_FORMATS_EXTENSION_NAME
  = (EQ ==) . cmpCStrings _VK_EXT_4444_FORMATS_EXTENSION_NAME
...
pattern VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT = VkFormat 1000340000

pattern VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT :: VkFormat

pattern VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT = VkFormat 1000340001
