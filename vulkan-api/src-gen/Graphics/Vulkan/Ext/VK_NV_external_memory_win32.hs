...
module Graphics.Vulkan.Ext.VK_NV_external_memory_win32
       (AHardwareBuffer(), ANativeWindow(), CAMetalLayer(), VkBool32(..),
        ...
        VkSampleMask(..), VkExportMemoryWin32HandleInfoNV,
...
--   >     )
--
--   <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#vkGetMemoryWin32HandleNV vkGetMemoryWin32HandleNV registry at www.khronos.org>
