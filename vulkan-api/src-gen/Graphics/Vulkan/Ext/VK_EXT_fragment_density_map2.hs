...
module Graphics.Vulkan.Ext.VK_EXT_fragment_density_map2
       (-- * Vulkan extension: @VK_EXT_fragment_density_map2@
        -- |
        --
        -- supported: @vulkan@
        --
        ...
        -- type: @device@
        --
        -- Extension number: @333@
        --
        -- Required extensions: 'VK_EXT_fragment_density_map'.
        --
...
import Graphics.Vulkan.Types.Enum.Image                    (VkImageViewCreateBitmask (..))
...
pattern VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME <-
        (is_VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME -> True)
  where
    VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME
      = _VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME

{-# INLINE _VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME #-}

_VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME :: CString
_VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME
  = Ptr "VK_EXT_fragment_density_map2\NUL"#

{-# INLINE is_VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME #-}

is_VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME :: CString -> Bool
is_VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME
  = (EQ ==) .
      cmpCStrings _VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME

type VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME =
