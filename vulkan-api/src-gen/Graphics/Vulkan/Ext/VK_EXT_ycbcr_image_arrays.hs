...
module Graphics.Vulkan.Ext.VK_EXT_ycbcr_image_arrays
       (-- * Vulkan extension: @VK_EXT_ycbcr_image_arrays@
        -- |
        --
        -- supported: @vulkan@
        --
        ...
        --
        -- Required extensions: 'VK_KHR_sampler_ycbcr_conversion'.
        --
        ...
        VkPhysicalDeviceYcbcrImageArraysFeaturesEXT, VkStructureType(..),
...
pattern VK_EXT_YCBCR_IMAGE_ARRAYS_SPEC_VERSION :: (Num a, Eq a) =>
        a
...
pattern VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME <-
        (is_VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME -> True)
  where
    VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME
      = _VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME

{-# INLINE _VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME #-}

_VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME :: CString
_VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME
  = Ptr "VK_EXT_ycbcr_image_arrays\NUL"#

{-# INLINE is_VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME #-}

is_VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME :: CString -> Bool
is_VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME
  = (EQ ==) . cmpCStrings _VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME

type VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME =
