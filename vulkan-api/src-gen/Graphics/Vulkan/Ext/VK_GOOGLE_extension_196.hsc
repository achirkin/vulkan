...
module Graphics.Vulkan.Ext.VK_GOOGLE_extension_196
       (-- * Vulkan extension: @VK_GOOGLE_extension_196@
        -- |
        --
        -- supported: @disabled@
        --
        ...
        -- author: @GOOGLE@
        --
        -- Extension number: @196@
        VK_GOOGLE_EXTENSION_196_SPEC_VERSION,
        pattern VK_GOOGLE_EXTENSION_196_SPEC_VERSION,
...
pattern VK_GOOGLE_EXTENSION_196_SPEC_VERSION = 0

type VK_GOOGLE_EXTENSION_196_SPEC_VERSION = 0

pattern VK_GOOGLE_EXTENSION_196_EXTENSION_NAME :: CString

pattern VK_GOOGLE_EXTENSION_196_EXTENSION_NAME <-
        (is_VK_GOOGLE_EXTENSION_196_EXTENSION_NAME -> True)
