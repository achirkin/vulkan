...
module Graphics.Vulkan.Ext.VK_NV_compute_shader_derivatives
       (-- * Vulkan extension: @VK_NV_compute_shader_derivatives@
        -- |
        --
        -- supported: @vulkan@
        --
...
import Graphics.Vulkan.Types.Struct.PhysicalDevice         (VkPhysicalDeviceComputeShaderDerivativesFeaturesNV,
...
pattern VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME <-
        (is_VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME -> True)
  where
    VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME
      = _VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME

{-# INLINE _VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME #-}

_VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME :: CString
_VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME
  = Ptr "VK_NV_compute_shader_derivatives\NUL"#

{-# INLINE is_VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME #-}

is_VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME ::
                                                   CString -> Bool
is_VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME
  = (EQ ==) .
      cmpCStrings _VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME

type VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME =
