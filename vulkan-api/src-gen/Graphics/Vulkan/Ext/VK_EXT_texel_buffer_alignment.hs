...
module Graphics.Vulkan.Ext.VK_EXT_texel_buffer_alignment
       (-- * Vulkan extension: @VK_EXT_texel_buffer_alignment@
        -- |
        --
        -- supported: @vulkan@
        --
...
pattern VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME <-
        (is_VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME -> True)
  where
    VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME
      = _VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME

{-# INLINE _VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME #-}

_VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME :: CString
_VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME
  = Ptr "VK_EXT_texel_buffer_alignment\NUL"#

{-# INLINE is_VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME #-}

is_VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME :: CString -> Bool
is_VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME
  = (EQ ==) .
      cmpCStrings _VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME

type VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME =
