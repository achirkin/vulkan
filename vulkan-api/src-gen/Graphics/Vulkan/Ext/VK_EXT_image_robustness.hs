...
module Graphics.Vulkan.Ext.VK_EXT_image_robustness
       (-- * Vulkan extension: @VK_EXT_image_robustness@
        -- |
        --
        -- supported: @vulkan@
        --
        ...
        VkPhysicalDeviceImageRobustnessFeaturesEXT, VkStructureType(..),
...
pattern VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME <-
        (is_VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME -> True)
  where
    VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME
      = _VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME

{-# INLINE _VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME #-}

_VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME :: CString
_VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME
  = Ptr "VK_EXT_image_robustness\NUL"#

{-# INLINE is_VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME #-}

is_VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME :: CString -> Bool
is_VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME
  = (EQ ==) . cmpCStrings _VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME

type VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME =
